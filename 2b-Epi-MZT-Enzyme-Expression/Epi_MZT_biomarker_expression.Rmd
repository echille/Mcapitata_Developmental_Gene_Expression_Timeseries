...
```{r}
counts <- as.data.frame(read.csv("1-QC-Align-Assemble/Output/gene_abund_TPM.csv", row.names="gene_id"), colClasses = double) #Load normalized expression matrix from stringtie
```
