...
```{r, message=FALSE, warning=FALSE}
MatGO <- read_csv("Output/RNAseq/MatWGCNA.GO.05.csv", col_names = TRUE)
...
pdf(file = "Output/RNAseq/MatBP_GOSEM.pdf", width = 7, height = 5)
...
Load GO data and select only the GO_IDs associated with BP terms
```{r, message=FALSE, warning=FALSE}
UEGO <- read_csv("Output/RNAseq/UEWGCNA.GO.05.csv", col_names = TRUE)
...
pdf(file = "Output/RNAseq/UEBP_GOSEM.pdf", width = 7, height = 5)
...
Load GO data and select only the GO_IDs associated with BP terms
```{r, message=FALSE, warning=FALSE}
FEGO <- read_csv("Output/RNAseq/FEWGCNA.GO.05.csv", col_names = TRUE)
...
pdf(file = "Output/RNAseq/FEBP_GOSEM.pdf", width = 7, height = 5)
...
Load GO data and select only the GO_IDs associated with BP terms
```{r, message=FALSE, warning=FALSE}
ZGA1GO <- read_csv("Output/RNAseq/ZGA1WGCNA.GO.05.csv", col_names = TRUE)
...
pdf(file = "Output/RNAseq/ZGA1_GOSEM.pdf", width = 7, height = 5)
...
Load GO data and select only the GO_IDs associated with BP terms
```{r, message=FALSE, warning=FALSE}
ClvgGO <- read_csv("Output/RNAseq/ClvgWGCNA.GO.05.csv", col_names = TRUE)
...
pdf(file = "Output/RNAseq/ClvgBP_GOSEM.pdf", width = 7, height = 5)
...
Load GO data and select only the GO_IDs associated with BP terms
```{r, message=FALSE, warning=FALSE}
PCGO <- read_csv("Output/RNAseq/PCWGCNA.GO.05.csv", col_names = TRUE)
...
pdf(file = "Output/RNAseq/PCBP_GOSEM.pdf", width = 7, height = 5)
...
Load GO data and select only the GO_IDs associated with BP terms
```{r, message=FALSE, warning=FALSE}
EGGO <- read_csv("Output/RNAseq/EGWGCNA.GO.05.csv", col_names = TRUE)
...
pdf(file = "Output/RNAseq/EGBP_GOSEM.pdf", width = 7, height = 5)
...
Load GO data and select only the GO_IDs associated with BP terms
```{r, message=FALSE, warning=FALSE}
ZGA2GO <- read_csv("Output/RNAseq/ZGA2WGCNA.GO.05.csv", col_names = TRUE)
...
pdf(file = "Output/RNAseq/ZGA2BP_GOSEM.pdf", width = 7, height = 5)
...
Load GO data and select only the GO_IDs associated with BP terms
```{r, message=FALSE, warning=FALSE}
MGGO <- read_csv("Output/RNAseq/MGWGCNA.GO.05.csv", col_names = TRUE)
...
pdf(file = "Output/RNAseq/MGBP_GOSEM.pdf", width = 7, height = 5)
...
Load GO data and select only the GO_IDs associated with BP terms
```{r, message=FALSE, warning=FALSE}
LGGO <- read_csv("Output/RNAseq/LGWGCNA.GO.05.csv", col_names = TRUE)
...
pdf(file = "Output/RNAseq/LGBP_GOSEM.pdf", width = 7, height = 5)
...
Load GO data and select only the GO_IDs associated with BP terms
```{r, message=FALSE, warning=FALSE}
PlnGO <- read_csv("Output/RNAseq/PlnWGCNA.GO.05.csv", col_names = TRUE)
...
pdf(file = "Output/RNAseq/PlnBP_GOSEM.pdf", width = 7, height = 5)
...
Load GO data and select only the GO_IDs associated with BP terms
```{r, message=FALSE, warning=FALSE}
AdultGO <- read_csv("Output/RNAseq/AdultWGCNA.GO.05.csv", col_names = TRUE)
...
Calculate a similarity matrix and save the output.
```{r}
pdf(file = "Output/RNAseq/AdultBP_GOSEM.pdf", width = 7, height = 5)
...
write.csv(GO05.BP, "Output/stage_GO05_BP.csv", row.names = FALSE)
# 
