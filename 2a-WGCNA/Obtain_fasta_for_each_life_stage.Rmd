...
dat2fasta(na.omit(ref[FE$gene_id,]), "2a-WGCNA/Output/Mcap_fertilized_egg.fasta")
dat2fasta(na.omit(ref[Clvg$gene_id,]), "2a-WGCNA/Output/Mcap_cleavage.fasta")
dat2fasta(na.omit(ref[PC$gene_id,]), "2a-WGCNA/Output/Mcap_prawn_chip.fasta")
dat2fasta(na.omit(ref[EG$gene_id,]), "2a-WGCNA/Output/Mcap_early_gastrula.fasta")
dat2fasta(na.omit(ref[MG$gene_id,]), "2a-WGCNA/Output/Mcap_mid_gastrula.fasta")
dat2fasta(na.omit(ref[LG$gene_id,]), "2a-WGCNA/Output/Mcap_late_gastrula.fasta")
dat2fasta(na.omit(ref[Pln$gene_id,]), "2a-WGCNA/Output/Mcap_planula.fasta")
dat2fasta(na.omit(ref[Adult$gene_id,]), "2a-WGCNA/Output/Mcap_adult.fasta")
```
